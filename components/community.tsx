...
const stats = [
  { icon: Users, value: '15K+', label: 'Members' },
  { icon: Trophy, value: '500+', label: 'Tournaments' },
  { icon: Zap, value: '24/7', label: 'Active' },
  { icon: MessageCircle, value: '1M+', label: 'Messages' },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-lg mb-8 leading-relaxed">
              Connect with thousands of gamers, developers, and creators. Share your projects, 
              get feedback, participate in tournaments, and be part of something epic.
            </p>
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <span className="text-sm text-white/60">
                <span className="text-green-400 font-semibold">2,847</span> members online right now
              </span>
            </div>
          </motion.div>
