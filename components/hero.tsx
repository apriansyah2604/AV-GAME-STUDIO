    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden" suppressHydrationWarning>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <span className="w-2 h-2 rounded-none bg-[#ff4655] animate-pulse"></span>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl lg:text-9xl font-black tracking-tight mb-6 leading-[0.9] px-2 uppercase"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-lg lg:text-xl text-white/60 max-w-2xl mx-auto mb-10 font-medium tracking-normal px-4 leading-relaxed"
          >
            {t('hero.subtitle')}
            <span className="block mt-2 text-xs sm:text-sm text-[#ff4655] font-black uppercase">
              {t('hero.subtitle2')}
            </span>
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-col items-stretch justify-center gap-3 px-4"
        >
          <motion.a
            href="#projects"
            onClick={(e) => handleCtaClick(e, '#projects')}
            className="group relative px-6 py-3 sm:py-4 rounded-none overflow-hidden text-center"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            <div className="absolute inset-0 bg-[#ff4655] skew-x-[-12deg]" />
            <span className="relative flex items-center justify-center gap-2 font-black tracking-normal text-white uppercase text-sm sm:text-lg skew-x-[12deg]">
          ...
          <motion.a
            ...
            className="group relative px-6 py-3 sm:py-4 rounded-none overflow-hidden text-center border-2 border-white/20"
            whileHover={{ scale: 1.02, borderColor: '#ff4655' }}
            whileTap={{ scale: 0.98 }}
          >
          ...
          <div className="relative">
            <motion.button
              ...
              className="group relative w-full px-6 py-3 sm:py-4 rounded-none overflow-hidden text-center border-2 border-[#ff4655]/40"
              whileHover={{ scale: 1.02, borderColor: '#ff4655' }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="absolute inset-0 bg-[#ff4655]/10 skew-x-[-12deg] group-hover:bg-[#ff4655]/20 transition-colors" />
              <span className="relative flex items-center justify-center gap-2 font-black tracking-normal text-white uppercase text-sm sm:text-lg skew-x-[12deg]">
                <Gamepad2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#ff4655]" />
                Top Up Game
            ...
            {isTopUpMenuOpen && (
              <motion.div
                ...
                className="absolute left-0 right-0 top-full z-30 mt-3 overflow-hidden border border-[#ff4655]/25 bg-[#090405]/95 text-left shadow-lg shadow-[#ff4655]/10 backdrop-blur-xl"
              >
                {topUpGames.map((game) => (
                  <a
                    key={game.name}
                    ...
                    className="flex items-center justify-between gap-4 border-b border-white/5 px-4 py-3 transition-colors last:border-b-0 hover:bg-[#ff4655]/10"
                  >
                    <span>
                    ...
                    <ShoppingCart className="w-4 h-4 shrink-0 text-[#ff4655]" />
                  </a>
                ))}
              </motion.div>
            )}
          ...
          <motion.a
            ...
            className="group relative px-6 py-3 sm:py-4 rounded-none glass border border-white/10 hover:border-[#ff4655] transition-colors text-center"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            <span className="relative flex items-center justify-center gap-2 font-black tracking-normal text-white/80 group-hover:text-white transition-colors text-xs sm:text-sm uppercase">
        ...
        <motion.div
          ...
          className="mt-10 sm:mt-16 grid grid-cols-3 gap-3 sm:gap-8 max-w-2xl mx-auto px-4"
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-xl sm:text-3xl font-black neon-text uppercase">{stat.value}</div>
              <div className="text-[10px] sm:text-xs text-white/50 tracking-normal mt-1 uppercase font-black">{stat.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
